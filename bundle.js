...
_react2['default'].render(_react2['default'].createElement(List, null), document.getElementById('container'));

},{"../src":159,"./index.scss":2,"react":158}],2:[function(require,module,exports){
      ...
      _createClass(_class, [{
        ...
        value: function attachEvents() {
          ...
          for (var key in this.events) {
            ...
            var _key$match = key.match(DELEGATE_EVENT_SPLITTER);

            var _key$match2 = _slicedToArray(_key$match, 3);

            var key = _key$match2[0];
            var _event = _key$match2[1];
...
},{"./vendor/delegatePolyfill":160,"react":158}],160:[function(require,module,exports){
